...
<form action="../controller/player_controller.php" method="POST">
    ...
    <label for="player1"><h5>Stricker:</h5></label>
      ...
      <select class="form-control" id="player1" name="player1" style="padding-top: 15px;">
    ...
    <div class="form-group">   
    <label for="player2"><h5>Non Stricker:</h5></label>
      <select class="form-control" id="player2" name="player2" style="padding-top: 15px;">

         <?php while($row2 = mysqli_fetch_assoc($TeamPlayerResult1)){ ?>

         Non Striker<option value="<?php echo $row2['id'] ?>" ><?php echo $row2['name'] ?></option>
         <?php } ?>
