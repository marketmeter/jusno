				...
				<div class="content-sidebar">
					<div class="sidebar_inner">
						...
						<div class="sidebar-button-group">
							<a href="about-us.php" class="sidebar-buttons material-button active"><i class="material-icons">&#xE851;</i><span class="btn-label">About Us</span></a>
							<!-- <a href="authors.html" class="sidebar-buttons material-button"><i class="material-icons">&#xE866;</i><span class="btn-label">Authors</span></a> -->
							<a href="privacy-policy.php" class="sidebar-buttons material-button"><i class="material-icons">&#xE87F;</i><span class="btn-label">Privacy Policy</span></a>
							<a href="contact-us.php" class="sidebar-buttons material-button"><i class="material-icons">&#xE894;</i><span class="btn-label">Contact Us</span></a>
						</div>
