...
<form action="addamount.php">
  ...
  <div class="form-group">
    ...
    <input type="cus_name" class="form-control" name="customername">
  </div>
  ...
  <div class="form-group">
    <label for="hour">Time in Hour</label>
    <input type="number" class="form-control" name="hour">
  </div>

    <div class="form-group">
    <label for="perhour">Price per Hour</label>
    <input type="number" class="form-control" name="perhour">
  </div>

<!--   <div class="form-group">
    <label for="collected">Collected</label>
    <input type="number" class="form-control" name="collected">
  </div> -->
