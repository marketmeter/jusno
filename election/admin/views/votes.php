...
$pid=$_GET['pid'];
$Sql = "SELECT name,id FROM candidates Where panchayath_id='$pid' and type='president'";

   $Team = mysqli_query($conn, $Sql);

?>
<form action="../controller/votes_controller.php" method="POST" enctype="multipart/form-data">
   ...
   <div class="" style="padding-bottom: 20px;"> <input type="number" placeholder="Ward"  name="ward" class="form-control"></div>

   <div class="" style="padding-bottom: 20px;"> <input type="number" placeholder="Votes"  name="votes" class="form-control"></div>
