...
$resultSql="SELECT candidate_name,candidate_id, symbol, type,sum(votes) as total_votes, ward, votes from votes WHERE panchayath_id and  candidate_id='$cid' group by ward";
...
<div class="container">
  ...
  <h4 style="text-align: center; color: brown;">Mallankulli Panchayath:<?php echo $nid; ?></h4>            
  <table class="table">
    <thead>
      <tr>
        <th>Ward</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="details.php?cid=<?php echo $row['candidate_id']; ?>"><?php echo $row['votes'];?></a></td>
    ...
    <?php }?>
      <tr>
        <td>Total</td>
        <td><a href="details.php?cid=<?php echo $row['candidate_id']; ?>"><?php echo $vid;?></a></td>
